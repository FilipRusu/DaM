...
import java.io.ByteArrayInputStream; // <--- NECESARIO PARA ENVIAR EL
import java.io.File;
...
try (ClientSession session = new ClientSession("localhost", 1984, "admin",
"admin")) {
...
"id='E1'><nombre>Laura</nombre><puesto>Jefa</puesto></empleado>";
...
System.out.println("Archivo " + archivoABorrar + " eliminado"+
"correctamente.");
}
...
private static void añadirFicheroDesdeOrdenador(ClientSession
session) {
try {
